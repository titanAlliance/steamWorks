...
public class OI {
    ...
    public OI() {
        ...
        fillHopperCamBtn = new JoystickButton(xbox, 3);
        fillHopperCamBtn.whenPressed(new cameraHopper());
        gearCamBtn = new JoystickButton(xbox, 2);
        gearCamBtn.whenPressed(new cameraGear());
        climbCamBtn = new JoystickButton(xbox, 1);
        climbCamBtn.whenPressed(new cameraClimb());
        rightJoystick = new Joystick(1);
        
        climbBtn = new JoystickButton(rightJoystick, 1);
        climbBtn.whileHeld(new climbRope());
        leftJoystick = new Joystick(0);
        
        joystickButton1 = new JoystickButton(leftJoystick, 1);
        joystickButton1.whenPressed(new backUpforGear());


        // SmartDashboard Buttons
        SmartDashboard.putData("backUpforGear", new backUpforGear());
